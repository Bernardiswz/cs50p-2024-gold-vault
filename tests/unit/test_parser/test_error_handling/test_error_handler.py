...
from gvault.error_handling.messages.parser_messages import USAGE  # type: ignore
...
class TestErrorHandler:
    ...
    def test_expected_exit_status(self, capsys: pytest.CaptureFixture) -> None:
        with pytest.raises(SystemExit) as excinfo:
            self.error_handler_instance.handle_parser_exception()
    ...
    def test_handle_invalid_path_type(self, capsys: pytest.CaptureFixture, path: str) -> None:
        ...
        with pytest.raises(SystemExit):
            self.error_handler_instance.handle_parser_exception(invalid_path_type_error)
    ...
    def test_handle_paths_list_len(self, capsys: pytest.CaptureFixture) -> None:
        ...
        with pytest.raises(SystemExit):
            self.error_handler_instance.handle_parser_exception(paths_list_len_error)
    ...
    def test_handle_path_not_found(self, capsys: pytest.CaptureFixture, path: str) -> None:
        ...
        with pytest.raises(SystemExit):
            self.error_handler_instance.handle_parser_exception(path_not_found_error)
